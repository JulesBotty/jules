...
const Regularisation = () => {
  ...
  return (
    ...
    : user.poste === "Declarant" ?
       ...
       <SidebarLayout title="Regularisation" items={navItemsd}>
      ...
      <section className="glass-card p-9 sm:p-6">
        ...
        >
          <option value=""> </option>
          <option value="exo">Dossiers en cours de Regularistion </option>
          <option value="nonexo"> Dossiers Regularisés</option>
        </select>
        </div>
      ...
      <div className="mb-5">
        <h1 className="text-2xl font-bold tracking-tight text-slate-800">Dossiers en cours de Regularistion</h1>
      </div> 
      
      :  rechercher === "nonexo" ?
       
       <div className="mb-5">
         <h1 className="text-2xl font-bold tracking-tight text-slate-800">Dossiers Regularisés</h1>
      </div>
            ...
            <table className="data-table">
              ...
              <tbody>
                ...
                { rechercher === "exo"  ?
                  ...
                  leavess.map((leave)=> (
                   <>
                  { leave.leaveType !== "Prestation"  &  leave.statusregul !== "Complet" ? 
                     

                     <tr key={leave._id}>
                    <td className="capitalize">{leave.nbDossier}</td>
                    <td className="capitalize">{leave.nbltabl}</td>
                    <td className="capitalize"> {leave.statusregul }</td>
